...
int main(int ac, char **av)
{
    ...
    std::cout << "Time to process a range of " << ac - 1 << " elements with std::vector: " << static_cast<double>(end - start) / CLOCKS_PER_SEC * 1000000 << " us" << std::endl;
    std::cout << "Time to process a range of " << ac - 1 << " elements with std::deque: " << static_cast<double>(dend - dstart) / CLOCKS_PER_SEC * 1000000 << " us" << std::endl;
